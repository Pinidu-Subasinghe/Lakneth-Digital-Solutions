    ...
    <section className="relative overflow-hidden py-24 px-6 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900 text-white text-center">
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-6">
          Let’s Build Your <span className="text-yellow-300">Digital Success Story</span>
        </h2>

        <p className="text-base sm:text-lg md:text-xl text-blue-100 dark:text-gray-300 mb-10 max-w-2xl">
          Whether you need web design, social media strategy, or SEO — Lakneth Digital Solutions
          will help you grow faster, smarter, and stronger online.
        </p>
