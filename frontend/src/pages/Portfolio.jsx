...
export default function Portfolio() {
  return (
    <section className="relative py-20 pt-10 bg-gray-950 min-h-screen overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {projects.map((p) => (
            <div
              key={p.id}
              className="relative rounded-xl overflow-hidden border border-gray-800 bg-gray-900/80 shadow-md transition-all duration-300 transform backdrop-blur-md group lg:hover:-translate-y-2 lg:hover:shadow-2xl"
            >
              {/* Hover Gradient Glow */}
